...
- [ ] **Step 1: Criar o projeto Supabase e ativar as sessões anónimas**
...
Sem isto, `signInAnonymously()` devolve erro e a porta de acesso da Task 9 nunca
chega a validar o código. As sessões anónimas não abrem acesso a dados: sem um
vínculo em `device_grants`, `current_group_ids()` devolve conjunto vazio e todas
as políticas negam.
